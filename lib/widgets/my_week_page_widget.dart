...
import 'package:fansinc/pages/my_week_image_page.dart';
                  ...
                  itemBuilder: (ctx, indexVal) {
                    return GestureDetector(
                      onTap: () => Navigator.of(context)
                          .pushNamed(MyWeekImagePage.routeName, arguments: {
                        'url': widget.myWeekList[indexVal].assetUrl[0],
                      }),
                      child: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            imageUrl: widget.myWeekList[indexVal].assetUrl[0],
